...
html=html.replaceAll('http://192.168.1.70:8787','http://192.168.1.70:8789');
html=html.replaceAll('http://192.168.1.70:8788','http://192.168.1.70:8789');
...
html=html.replace(
 ...
 "$ ('bridgeUrl')".replace(' ','')+".value='http://192.168.1.70:8789';$('ps5Ip').value=localStorage.getItem('gt7_ps5_ip')||'192.168.1.81';renderSegments(0);renderFuel(0);"
);
...
if(html.includes('http://192.168.1.70:8787')||html.includes('http://192.168.1.70:8788')||html.includes('192.168.1.68')||html.includes('192.168.1.71'))throw new Error('Configuração antiga ainda presente');
fs.writeFileSync(indexPath,html);
console.log('Conexão GT7 instalada: nova Bridge 192.168.1.70:8789 / PS5 padrão 192.168.1.81');
