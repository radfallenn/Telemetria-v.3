...
// Remove controladores adicionados por patches anteriores.
const markers=[
...
// Remove referência anterior ao arquivo extraído para manter idempotência.
html=html.replace(/\s*<script\s+src=["']bridge-v408\.js["']><\/script>\s*/ig,'\n');

// Corrige valores antigos que ainda possam existir no HTML base.
html=html.replaceAll('http://192.168.1.70:8787','http://192.168.1.70:8788');
html=html.replaceAll('192.168.1.68','192.168.1.71');

// Impede a inicialização automática do polling legado do HTML base.
